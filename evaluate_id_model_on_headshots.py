...
# a given dataset. The identification task here is to match second-day
# headshots to first-day headshots.
#
# Eero Holmstrom (2022)
#
...
def get_identification_accuracy(data_dictionary):
    ...
    #
    # Then, get the images to be identified, i.e., headshots of the
    # second shooting day.
    #
...
validation_data_accuracy, total_number_of_identifications = get_identification_accuracy(validation_data_dictionary)
